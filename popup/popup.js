const gamepadSimulator = {
    ...
    create: function () {
      document.querySelector("body").insertAdjacentHTML('beforeend', `<svg viewBox="0 0 600 300" id="amdfc-controller" width="350px" style="position: absolute; z-index: 999999; top: 0; left: 0;">
  <style>
  .amdfc-int:hover {
  fill: #bbb;
  }
  ...
  <circle cx="25" cy="25" r="20" class="amdfc-int" id="amdfc-power"></circle>
  ...
  <text id="power-text" x="25" y="25">OFF</text>
  ...
  <text x="330" y="175" font-size="10">START</text>
      ...
      Array.from(document.querySelectorAll(".amdfc-int")).forEach(function (element) {
        ...
        element.addEventListener("mouseup", function (e) {
          ...
          if (element.id.indexOf("amdfc-button") === 0) {
            ...
            gamepadSimulator.fakeController.axes[axe * 2 + pos] = 0;
            gamepadSimulator.fakeController.timestamp = Math.floor(Date.now() / 1000);
          } else if (element.id.indexOf("amdfc-power") === 0) {
      ...
      navigator.getGamepads = function () {
        return [ gamepadSimulator.fakeController ];
      }
    },
    destroy: function () {
